...
<body>
	<div class="" style="width: 500px;margin: 0 auto;padding-left: 50px;margin-top: 10px;font-size: 12px;">
        <form id="ff" method="post">
        	<input type="hidden" name="rep_id" value="${repaircar.rep_id }">
	    	<table cellpadding="5">
	    		<tr>
	    			<td>车牌号:</td>
	    			<td>
	    		...
	    		<tr>
	    			<td>维修厂:</td>
	    			<td>
	    				<input class="easyui-textbox" type="text" value="${repaircar.rep_maintain }" name="rep_maintain" data-options="required:true"  validType="midLength[5,10]" missingMessage="维修厂名字必填!"  style="width:250px;height:26px"/>
					</td>
	    		</tr>
	    		<tr>
	    			<td>维修详情:</td>
	    			<td><input class="easyui-textbox" type="text" value="${repaircar.rep_details }" name="rep_details" data-options="required:true"  validType="val[10,20]" missingMessage="维修详情必填!"  style="width:250px;height:26px"/></td>
	    		</tr>
	    		<tr>
	    			<td>共计费用:</td>
	    			<td><input class="easyui-textbox" type="text" value="${repaircar.rep_price }" name="rep_price" id="" data-options="required:true"style="width:250px;height:26px"/></td>
	    		</tr>
	    		<tr>
	    			<td>送修日期:</td>
	    			<td>
	    				<input class="easyui-datetimebox" name="rep_out_time"data-options="required:true,readonly:true,showSeconds:false,editable:false,panelWidth:250" value="${repaircar.rep_out_time }" style="width:250px;height:26px">
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>取车日期:</td>
	    			<td>
	    				<input class="easyui-datetimebox" name="rep_return_time" id="rep_return_time" data-options="showSeconds:false,readonly:true,editable:false,panelWidth:250" value="${repaircar.rep_return_time }" style="width:250px;height:26px">
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>修理备注:</td>
	    			<td>
	    				<input class="easyui-textbox" name="rep_notes" data-options="multiline:true" value="${repaircar.rep_notes }" style="width:300px;height:100px">
	    			</td>
	    		</tr>
	...
	$(function(){
		...
		//日期验证
		$('#rep_return_time').datebox({
			required:true , 
			missingMessage:'取车日期时间必填!' ,
			editable:false
		});
		//价格验证框
		$('#rep_price').numberbox({
